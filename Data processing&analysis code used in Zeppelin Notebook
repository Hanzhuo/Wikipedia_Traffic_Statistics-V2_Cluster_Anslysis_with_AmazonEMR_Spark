%python
#create dictionary to store page index as key and page name as value
index_name = dict()
f1=open('/home/hadoop/Desktop/686Project/big data/titles-sorted.txt')
index = 0
for name in f1:
    index += 1
    name = name.strip()
...
f2=open('/home/hadoop/Desktop/686Project/big data/links-simple-sorted.txt')
for line in f2:
    line = line.strip()
    from_to = line.split(': ')
...
f = open('/home/hadoop/Desktop/686Project/big data/name_inputNum.txt','w')
